...
st.markdown(
    """
    <div style="text-align:center; background-color:#D0F4F4; padding:20px; border-radius:10px;">
        <h1 style="color:#008080;">🎨 Image Enhancer Studio</h1>
...
if uploaded_file:
    ...
    brightness = st.slider("☀️ Brightness", 0.0, 2.0, 1.0)
    contrast = st.slider("🌓 Contrast", 0.0, 2.0, 1.0)
    sharpness = st.slider("✏️ Sharpness", 0.0, 2.0, 1.0)
